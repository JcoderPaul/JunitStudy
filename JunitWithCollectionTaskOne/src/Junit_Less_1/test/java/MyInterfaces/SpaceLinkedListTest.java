...
/*
Поскольку SpaceList интерфейс, а MySpaceList и MySpaceLinkedList
это классы реализующие его, то тесты на проверку работоспособности
их методов, будут практически похожи (если не идентичными).

И тогда, написав полный тест-лист для проверки, например, MySpaceList
...
public class SpaceLinkedListTest {
    ...
    */
    private MySpaceLinkedList linkedListOfSpaseObject;
    ...
    */
    ...
    public void setUp() throws Exception {
        ...
        */
        linkedListOfSpaseObject = new MySpaceLinkedList();
        // Заполняем его 50-ю элементами класса SpaceObject
        for (int i = 0; i < 50; i++) {
            linkedListOfSpaseObject.add(new SpaceObject("Asteroid" + i, i * 100.4));
        }
    }
    /*
    Первый тест.
    ...
    */
    ...
    public void testSizeAndTestClearInOneStep() {
        assertEquals(50, linkedListOfSpaseObject.size());
        linkedListOfSpaseObject.clear();
        assertEquals(0, linkedListOfSpaseObject.size());
    }
    ...
    */
    ...
    принадлежит классу MySpaceList, и возвращает
    ...
    */
    ...
    public void whenAdded50NotNullElementsThenSizeMustBeLikeSizeOfGetArraySize() {
        int count = linkedListOfSpaseObject.getArray().length;
    ...
    */
    ...
    public void whenElementRemovedByIndexThenSizeMustBeDecreased() {
        ...
        */
        assertTrue(linkedListOfSpaseObject.removeAt(9));
        /*
        ...
        */
        assertEquals(49, linkedListOfSpaseObject.size());
    }
    /*
    Шестой тест.
    ...
    */
    ...
    public void whenNonExistentElementRemovedThenReturnFalse() {
        SpaceObject nonExistentListItem =
                new SpaceObject("Kapella 542-23-45 Q", 49452.4);
        assertFalse(linkedListOfSpaseObject.remove(nonExistentListItem));
        assertEquals(50, linkedListOfSpaseObject.size());
    }
    /*
    Седьмой тест.
    ...
    */
    ...
    public void whenElementAddThenSizeMustBeIncrease() {
        SpaceObject elementAddedToTheList = new SpaceObject("Decamp 342-12", 23581.3);
        linkedListOfSpaseObject.add(elementAddedToTheList);
        assertEquals(51, linkedListOfSpaseObject.size());
    }
    /*
    Восьмой тест.
    ...
    public void whenElementRemovedThenSizeMustBeDecreased() {
        ...
        */
        SpaceObject elementToBeRemovedFromTheList =
                new SpaceObject("Asteroid0", 0.0);
        // Удаляем и получаем возвращаемое значение boolean
        assertTrue(linkedListOfSpaseObject.remove(elementToBeRemovedFromTheList));
    ...
    */
    ...
    public void whenIndexOutOfBoundsThenThrownException() {
        linkedListOfSpaseObject.get(67);
    }
    /*
    Десятый тест.
    ...
    */
    ...
    public void methodGetReturnedRightValue() {
        SpaceObject getZeroTestElementOfArray = linkedListOfSpaseObject.get(0);
