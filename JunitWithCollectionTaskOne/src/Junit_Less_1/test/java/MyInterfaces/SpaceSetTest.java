...
public class SpaceSetTest {
    ...
    */
    ...
    public void setUp() throws Exception {
        ...
        for (int i = 0; i < 50; i++) {
            hashSetOfSpaseObject.add(new SpaceObject("Asteroid" + i, i * 100.4));
        }
    }
    /*
    ...
    */
    ...
    public void whenElementRemovedByIndexThenSizeMustBeDecreased() {
            assertTrue(hashSetOfSpaseObject.remove(new SpaceObject("Asteroid0",0)));
    ...
    */
    @Test
    public void size() {
        SpaceObject elementAddedToTheList = new SpaceObject("Volopas 4325-23-V", 21581.3);
        hashSetOfSpaseObject.add(elementAddedToTheList);
        assertEquals(51, hashSetOfSpaseObject.size());
        assertTrue(hashSetOfSpaseObject.remove(new SpaceObject("Asteroid1",100.4)));
    ...
    */
    ...
    public void whenNonExistentElementRemovedThenReturnFalse() {
        SpaceObject nonExistentListItem = new SpaceObject("Kapella 542-23-45 Q", 49452.4);
    ...
    public void whenElementAddThenSizeMustBeIncrease() {
        SpaceObject elementAddedToTheList = new SpaceObject("Orcad 743342-121", 23581.3);
        hashSetOfSpaseObject.add(elementAddedToTheList);
        assertEquals(51, hashSetOfSpaseObject.size());
    }
    ...
    public void whenElementRemovedThenSizeMustBeDecreased() {
        SpaceObject elementToBeRemovedFromTheList = new SpaceObject("Asteroid2", 200.8);
    ...
    public void testContainsMethod() {
        ...
        */
        assertTrue(hashSetOfSpaseObject.contains(new SpaceObject("Asteroid2", 200.8)));
        assertFalse(hashSetOfSpaseObject.contains(new SpaceObject("Wolf 342-12-K", 83581.3)));
    }
    /*
    ...
    */
    ...
    public void whenSameElementRemovedTwiceSizeDecreasedOne() {
        ...
        */
        hashSetOfSpaseObject.add(new SpaceObject("Asteroid2", 200.8));
        assertEquals(50, hashSetOfSpaseObject.size());
        assertTrue(hashSetOfSpaseObject.remove(new SpaceObject("Asteroid2", 200.8)));
        assertEquals(49, hashSetOfSpaseObject.size());
        assertFalse(hashSetOfSpaseObject.remove(new SpaceObject("Asteroid2", 200.8)));
        assertEquals(49, hashSetOfSpaseObject.size());
    }
}