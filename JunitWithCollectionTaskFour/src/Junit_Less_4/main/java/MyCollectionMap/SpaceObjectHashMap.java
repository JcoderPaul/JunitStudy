...
public class SpaceObjectHashMap implements SpaceObjectMap {
    ...
    */
    @Override
    public void put(Discoverer key, SpaceObject value) {
        /*
    ...
    private boolean put(Discoverer key, SpaceObject value, Entry[] dst) {
        /*
    ...
    @Override
    public SpaceObject get(Discoverer key) {
    ...
    */
    @Override
    public Set<Discoverer> keySet() {
        // Создаем результирующую коллекцию всех ключей
        Set<Discoverer> result = new HashSet<>();
    ...
    */
    @Override
    public List<SpaceObject> values() {
        // Создаем список
    ...
    @Override
    public boolean remove(Discoverer key) {
    ...
    */
    private int getElementPosition(Discoverer discoverer, int arrayLength) {
        return Math.abs(discoverer.hashCode() % arrayLength);
    }
    ...
    */
    private static class Entry {
        private Discoverer key; // Значение ключа
        private SpaceObject value; // Объект для хранения
        private Entry next; // Ссылка на следующий объект в односвязном списке (бакете)

        public Entry(Discoverer key, SpaceObject value, Entry next) {
            this.key = key;
            this.value = value;
            this.next = next;
        }
