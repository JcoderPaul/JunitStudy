package MySimpleLinkedList.MySpaceQueue;
/*
Превращаем нашу коллекцию LinkedList в
коллекцию очередь Queue.
*/
import MyClasses.SpaceObject;
import MyInterfaces.SpaceObjectQueue;

import java.util.Iterator;
import java.util.NoSuchElementException;

public class MySpaceObjectQueue implements SpaceObjectQueue {
    /*
    ...
    */
    ...
    public SpaceObject element() {
        ...
        SpaceObject spaceObject = get(0);
        return spaceObject;
        }
    }

    @Override
    public SpaceObject peek() {
        return size > 0 ? get(0) : null;
    }

    @Override
    public SpaceObject poll() {
        if (size == 0){
            return null;
        } else {
            SpaceObject spaceObject = get(0);
        ...
        return new Iterator<SpaceObject>() {
            ...
            */
            ...
            public SpaceObject next() {
                SpaceObject spaceObject = node.value;
                node = node.next;
                /*
            ...
            */
            @Override
            public void remove() {
                MySpaceObjectQueue.this.removeAt(--index);
            }
        };
    }
