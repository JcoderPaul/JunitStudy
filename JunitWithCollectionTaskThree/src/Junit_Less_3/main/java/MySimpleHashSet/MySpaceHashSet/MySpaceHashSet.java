package MySimpleHashSet.MySpaceHashSet;

import MyClasses.SpaceObject;
import MyInterfaces.SpaceSet;

import java.util.Iterator;

public class MySpaceHashSet implements SpaceSet {
        ...
        private Entry[] array = new Entry[INITIAL_CAPACITY]; // Пустой массив Entry
        /*
        ...
        public boolean add(SpaceObject spaceObject) {
            ...
            */
            boolean added = add(spaceObject, array);
        ...
        */
        private boolean add(SpaceObject spaceObject, Entry[] dst) {
            // Расчет позиции
            int position = getElementPosition(spaceObject, dst.length);
            /*
            ...
            */
            if (dst[position] == null) {
                ...
                Entry entry = new Entry(spaceObject, null);
                dst[position] = entry;
                ...
                */
                while (true) {
                    ...
                    */
                    if (existedElement.value.equals(spaceObject)) {
                        ...
                        */
                        ...
                        на пустоту.
                        */
                        existedElement.next = new Entry(spaceObject, null);
        ...
        public boolean remove(SpaceObject spaceObject) {
            ...
            */
            int position = getElementPosition(spaceObject, array.length);
            ...
            один элемент).
            */
            Entry preLast = array[position]; // Поиск идет с головы списка, запоминаем ее
            Entry last = preLast.next; // И запоминаем следующий после нее объект
            if (preLast.value.equals(spaceObject)) { // Если удаляемый элемент это голова, то...
            ...
            */
            while (last != null) {
                ...
                if (last.value.equals(spaceObject)) {
                    /*
    ...
    public boolean contains(SpaceObject spaceObject) {
        Entry[] currentArray = this.array; // Обращаемся к текущему массиву
        ...
        for (int i = 0; i < this.array.length; i++) {
            ...
            nextEntryForFindElement = currentArray[i];
    ...
    */
    ...
    public boolean isEmpty() {
        ...
        for (int i = 0; i < this.array.length; i++) {
            ...
            Entry possiblyNotAnEmptyElement = currentArray[i];
    ...
    */
        ...
        */
        private int getElementPosition(SpaceObject spaceObject, int arrayLength) {
            return Math.abs(spaceObject.hashCode() % arrayLength);
        }
    ...
    public Iterator<SpaceObject> iterator() {
        return new Iterator<SpaceObject>() {
            ...
            public SpaceObject next() {
                ...
                SpaceObject result = entry.value;
                curEntry = entry;
                entry = entry.next;
                if (entry == null) {
                    arrayIndex++;
            ...
            @Override
            public void remove(){
                MySpaceHashSet.this.remove(curEntry.value);
                index--;
            }
        };
    }
    ...
    */
    ...
    public Entry[] allHashSetElementToSimpleArray() {
        Entry[] currentArray = this.array;
        Entry[] allElementOfSet = new Entry[size];
        int j = 0;
        Entry nextEntryForNewArray;
        for (int i = 0; i < this.array.length; i++) {
            nextEntryForNewArray = currentArray[i];
